...
// Class definition with full features
public class Customer
{
    ...
    // Constructors
    public Customer() // Parameterless
    {
        Id = GenerateId();
    }
    
    public Customer(string name, string email) : this() // Constructor chaining
    {
        Name = name;
        Email = email;
    }
    ...
    // Methods
    public virtual void Save() // Virtual allows overriding
    {
        Console.WriteLine("Saving customer...");
    }
    
    // Method overloading (compile-time polymorphism)
    public void SendEmail(string subject) => SendEmail(subject, "Default body");
...
public class PremiumCustomer : Customer
{
    ...
    public PremiumCustomer(string name, string email, decimal discount) 
        : base(name, email)
    {
    ...
    {
        base.Save(); // Call base implementation
        Console.WriteLine("Saving premium benefits...");
    }
}
...
{
    public abstract void ProcessPayment(decimal amount); // Must be implemented
    
    public void LogTransaction() // Concrete method
    {
